...
const checkRefs=(doc)=>{
  ...
  for(const component of doc.components||[]){if(component.parent_id)known([component.parent_id],componentIds,'component',component.id);known(component.evidence_ids||[],evidenceIds,'evidence',component.id)}
